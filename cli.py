...
def main(args):
    ...
    try:
        torch.cuda.set_device(0)  # 或者使用 cuda:1，取决于你想用哪个 GPU
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", type=str, default="test_mhc_vicuna-7b-v1.5_headsnum_5_lr_0.001_layersnum_1", help="Model name or path.")
    parser.add_argument(
